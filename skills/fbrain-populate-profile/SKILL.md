---
name: fbrain-populate-profile
description: >
  Build the user's fbrain profile from real data sources. Use when the user
  asks to "populate my profile", "build my context", "set up fbrain", or when
...
attorney contact, a funding round closing date), use the `fbrain-write-fact`
